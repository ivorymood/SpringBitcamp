...
<table id="join_table">
	<tr>
		<td>아이디</td>
		<td>
			<input id="join_input_id" name="join_id" 
			 type="text" name="id" /> 
	...
	<tr>
		<td>이름</td>
		<td>
			<input id="join_input_name" name="join_name" 
	...
	<tr>
		<td>비밀번호</td>
		<td>
			<input id="join_input_pass" name="join_pass" type="text"  /> 
...
$('#join_confirm_btn').on('click', function(){
	var userid = $('#join_input_id').val();
	var password =$('#join_input_pass').val();
	var name = $('#join_input_name').val();
	location.href = "${path.ctx}/join/"+userid+"/"+password+"/"+name;
});
</script>
</html>